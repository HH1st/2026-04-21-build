...
const material = new THREE.ShaderMaterial({
  ...
  fragmentShader: `
    ...
    vec3 iridescence(float t) {
      // oil-slick hue sweep: deep blue -> teal -> gold -> rose
    ...
    void main() {
      ...
      // counter-rotating pairs for a galaxy/yin-yang feel
      ...
      // bias shimmer toward gold side; on cooler areas let blue show through
