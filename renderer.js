...
const RENDER_CONFIG = {
  ...
  stateAnimation: {
    idle: { pointerLerp: 0.06, timeScale: 1.0 },
    listening: { pointerLerp: 0.12, timeScale: 1.2 },
    thinking: { pointerLerp: 0.04, timeScale: 0.8 },
    speaking: { pointerLerp: 0.09, timeScale: 1.4 }
  }
};
...
export function createFluidRenderer(options = {}) {
  ...
  function animate(time) {
    ...
    uniforms.uTime.value = time * stateAnimation.timeScale;
    uniforms.uPointer.value.lerp(pointerTarget, stateAnimation.pointerLerp);
